  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">full-stack(frontend heavy) developer</span>{" "}
        with <span className="font-bold">2.8 years</span> of experience. I enjoy
      ...
      >
        ...
        <a
          ...
          href="https://docs.google.com/document/d/1lMgspoJzvV08Kczwbp2jv2oQ_WhlQtJ4LweFB5cyksc/export?format=pdf"
          download
        >
          Download CV{" "}
